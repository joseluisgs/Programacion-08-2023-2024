...
fun main() {
    ...
    //checkMyModules() // Verificamos que los módulos están bien configurados antes de inyectarlos
    ...
    startKoin {
        ...
        modules(listOf(configModule, databaseModule, clientesModule, productosModule, ventasModule))
    }
...
fun checkMyModules() {
    ...
    checkKoinModules(listOf(configModule, databaseModule, clientesModule, productosModule, ventasModule))
}
