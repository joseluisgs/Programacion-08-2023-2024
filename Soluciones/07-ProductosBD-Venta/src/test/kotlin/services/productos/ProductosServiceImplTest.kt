...
class ProductosServiceImplTest {
    ...
    fun getByCategoria() {
        ...
        val productos = service.getByCategoria(categoria)
    ...
    fun getById() {
        ...
        val producto = service.getById(id)
    ...
    fun `getById throws ProductoNoEncontrado exception when producto not found`() {
        ...
        val exception = assertThrows<ProductosExceptions.ProductoNoEncontrado> {
            service.getById(id)
        }

        assertEquals("Producto no encontrado con id: $id", exception.message)
    ...
    fun save() {
        ...
        val producto = service.create(newProducto)
    ...
    fun update() {
        ...
        val producto = service.update(id, updatedProducto)
    ...
    fun `update throws ProductoNoActualizado exception when producto not updated`() {
        ...
        val exception = assertThrows<ProductosExceptions.ProductoNoActualizado> {
            service.update(id, updatedProducto)
        }

        assertEquals("Producto no actualizado con id: $id", exception.message)
    ...
    fun delete() {
        ...
        val producto = service.delete(id)
    ...
    fun `delete throws ProductoNoEliminado exception when producto not deleted`() {
        ...
        val exception = assertThrows<ProductosExceptions.ProductoNoEliminado> {
            service.delete(id)
        }

        assertEquals("Producto no eliminado con id: $id", exception.message)
